...
class Mpm < Formula
    ...
    if Hardware::CPU.arm?
        url "https://github.com/ywl0806/mpm/releases/download/v1.0.0/mpm_darwin_arm64.tar.gz"
        sha256 "26c884ab5eb0fcb0d4394ac387d98974b2066fe40b524f9eb62eea6d864a6901"
      else
        url "https://github.com/ywl0806/mpm/releases/download/v1.0.0/mpm_darwin_amd64.tar.gz"
